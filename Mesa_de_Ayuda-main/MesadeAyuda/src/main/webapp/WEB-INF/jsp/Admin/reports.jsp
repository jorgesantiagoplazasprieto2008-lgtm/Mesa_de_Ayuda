<%-- 
    Document   : reports
    Created on : 13/08/2026, 1:44:29â€¯p.Â m.
    Author     : Dissmax
--%>
        ...
        <div class="row">
            ...
            <main class="col-md-10 ms-sm-auto px-md-4 py-4">
                <div class="d-flex justify-content-between align-items-center pb-2 mb-3 border-bottom">
                    <h1 class="h2"><i class="fas fa-chart-bar me-2 text-primary"></i>Reportes y MÃ©tricas</h1>
                ...
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            <div class="card-body text-center">
                                <h6 class="text-muted">Tasa de resoluciÃ³n</h6>
                ...
                <!-- GrÃ¡ficos simulados (usando Bootstrap + CSS) -->
                <div class="row g-4">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="card shadow-sm">
                            <div class="card-header bg-white">
                                <h5 class="mb-0"><i class="fas fa-chart-simple me-2"></i>Tickets por CategorÃ­a</h5>
                            </div>
                            <div class="card-body">
                                <div class="d-flex justify-content-between mb-2">
                                    <span>ðŸŒ Red</span>
