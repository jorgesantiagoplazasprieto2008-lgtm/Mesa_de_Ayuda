<%-- 
    Document   : Dashboard
    Created on : 13/08/2026, 1:40:26â€¯p.Â m.
    Author     : Dissmax
--%>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="${pageContext.request.contextPath}/DashboardServlet"><i class="fas fa-home me-1"></i>Dashboard</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/TicketServlet?action=list"><i class="fas fa-ticket-alt me-1"></i>Tickets</a>
                    </li>
                    <c:if test="${usuarioLogueado.rol == 'SOLICITANTE'}">
<li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/TicketServlet?action=create"><i class="fas fa-plus-circle me-1"></i>Nuevo Ticket</a>
                    </li>
</c:if>
                </ul>
                <ul class="navbar-nav">
            ...
            <nav class="col-md-2 d-md-block bg-light sidebar vh-100 p-3">
                <div class="position-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="${pageContext.request.contextPath}/TicketServlet?action=list">
                                <i class="fas fa-list me-2"></i>Mis Tickets
                            </a>
                        </li>
                        <c:if test="${usuarioLogueado.rol == 'SOLICITANTE'}">
<li class="nav-item">
                            <a class="nav-link" href="${pageContext.request.contextPath}/TicketServlet?action=create">
            ...
            <main class="col-md-10 ms-sm-auto px-md-4 py-4">
                    ...
                    <div class="col-md-3">
                        <div class="card text-white bg-warning h-100">
                            <div class="card-body">
                                ...
                                <small><i class="fas fa-clock me-1"></i>3 con SLA prÃ³ximo a vencer</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card text-white bg-success h-100">
                            <div class="card-body">
                                ...
                                <small><i class="fas fa-check me-1"></i>92% de satisfacciÃ³n</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card text-white bg-danger h-100">
                            <div class="card-body">
                                ...
                                <small><i class="fas fa-flag me-1"></i>AcciÃ³n prioritaria requerida</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        <h5 class="mb-0"><i class="fas fa-clock-rotate-left me-2"></i>Ãšltimos tickets</h5>
                        <a href="${pageContext.request.contextPath}/TicketServlet?action=list" class="btn btn-sm btn-primary">
                            ...
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="${pageContext.request.contextPath}/TicketServlet?action=detail" class="text-decoration-none">Equipo no enciende</a></td>
                                        <td><span class="badge bg-info">Hardware</span></td>
                                        <td><span class="badge bg-danger">CrÃ­tica</span></td>
                                        <td><span class="badge bg-warning text-dark">En Proceso</span></td>
                                        <td><i class="fas fa-user-tie me-1"></i>Carlos R.</td>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/TicketServlet?action=detail" class="btn btn-sm btn-outline-primary">
