<%-- 
    Document   : detail
    Created on : 13/08/2026, 1:42:42 p. m.
    Author     : Dissmax
--%>
...
<head>
    ...
    <title>Detalle Ticket #T-001 - Mesa de Ayuda</title>
            ...
            <main class="col-md-10 ms-sm-auto px-md-4 py-4">
                    ...
                    <div>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-1">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">#T-001</li>
                            </ol>
                        </nav>
                        <h1 class="h2 mt-1"><i class="fas fa-ticket me-2 text-primary"></i>Ticket #T-001</h1>
                    </div>
                    <div class="btn-group">
                ...
                <div class="row g-4">
                        ...
                        <div class="card shadow-sm mb-4">
                            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    <span class="badge bg-danger"><i class="fas fa-flag me-1"></i>Crítica</span>
                                </div>
                            </div>
                            <div class="card-body">
                                <h4 class="card-title">Equipo no enciende - Laboratorio 302</h4>
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <p><strong><i class="fas fa-tag me-1"></i>Categoría:</strong> Hardware</p>
                                        <p><strong><i class="fas fa-user me-1"></i>Solicitante:</strong> María González</p>
                                        <p><strong><i class="fas fa-calendar me-1"></i>Fecha creación:</strong> 10/08/2026 09:30</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong><i class="fas fa-user-tie me-1"></i>Asignado a:</strong> Carlos Rodríguez</p>
                                        <p><strong><i class="fas fa-circle me-1"></i>Estado:</strong> <span class="badge bg-warning text-dark">En Proceso</span></p>
                                        <p><strong><i class="fas fa-clock me-1"></i>Última actualización:</strong> 10/08/2026 11:45</p>
                                    </div>
                                </div>
                                <hr>
                                <h6><i class="fas fa-align-left me-2"></i>Descripción</h6>
                                <p class="text-muted">El equipo del laboratorio 302 no enciende al presionar el botón de encendido. Se escucha un ruido extraño proveniente de la fuente de poder. El equipo es fundamental para la clase de diseño asistido por computador que inicia a las 2:00 PM. Se solicita prioridad máxima.</p>
                            </div>
                        </div>

                        <!-- Acciones según estado (Botones) -->
                        <div class="card shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-wrap gap-2">
                                    <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#changeStateModal">
                                        <i class="fas fa-forward me-1"></i>Avanzar Estado
                                    </button>
                                    ...
                                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#closeModal">
                                        <i class="fas fa-check-circle me-1"></i>Cerrar (Solicitante)
                                    </button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex gap-3 mb-3 pb-3 border-bottom">
                                    ...
                                    <div>
                                        <h6 class="mb-0">Carlos Rodríguez <small class="text-muted">(Agente)</small></h6>
                                        <small class="text-muted">10/08/2026 10:15</small>
                                        <p class="mt-1 mb-0">He revisado la fuente de poder y parece dañada. Solicito autorización para cambiar la fuente de una PC en desuso.</p>
                                    </div>
                                </div>
                                <div class="d-flex gap-3 mb-3 pb-3 border-bottom">
                                    <div class="flex-shrink-0">
                                    ...
                                    <div>
                                        <h6 class="mb-0">María González <small class="text-muted">(Solicitante)</small></h6>
                                        <small class="text-muted">10/08/2026 10:45</small>
                                        <p class="mt-1 mb-0">Autorizado. Por favor, hazlo lo más rápido posible, tenemos clase a las 2:00 PM.</p>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card shadow-sm mb-4">
                            <div class="card-header bg-white">
                                <h5 class="mb-0"><i class="fas fa-chart-simple me-2"></i>Métricas</h5>
                            </div>
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <span>Tiempo transcurrido:</span>
                                    <span class="fw-bold">2h 15m</span>
                                </div>
                                <div class="d-flex justify-content-between mt-2">
                                    <span>SLA restante:</span>
                                    <span class="fw-bold text-danger">2h 30m</span>
                                </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <span><i class="fas fa-exchange-alt me-1"></i>Cambios de estado:</span>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Ticket: <strong>#T-001</strong></p>
                    <p>Estado actual: <span class="badge bg-warning text-dark">En Proceso</span></p>
                    <div class="mb-3">
                        <label class="form-label">Nuevo estado</label>
                        <select class="form-select">
                            <option value="RESUELTO">✅ Resuelto</option>
                            <option value="CERRADO">🔒 Cerrar (solo solicitante)</option>
