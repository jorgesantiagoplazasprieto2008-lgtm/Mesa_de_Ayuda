<%-- 
    Document   : create
    Created on : 13/08/2026, 1:43:06 p. m.
    Author     : Dissmax
--%>
...
<body>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown">
                            <i class="fas fa-user-circle me-1"></i>María G.
                        </a>
        ...
        <div class="row">
            ...
            <main class="col-md-10 ms-sm-auto px-md-4 py-4">
                ...
                <div class="card shadow-sm">
                    <div class="card-body p-4">
                        <form action="#" method="post">
                            <!-- Título -->
                            <div class="mb-3">
                                <label for="titulo" class="form-label fw-bold"><i class="fas fa-heading me-1"></i>Título del problema</label>
                                <input type="text" class="form-control form-control-lg" id="titulo" placeholder="Resumen claro del problema (ej: Equipo no enciende)" required>
                            </div>

                            <div class="row g-3">
                                <!-- Categoría -->
                                <div class="col-md-6">
                                    <label for="categoria" class="form-label fw-bold"><i class="fas fa-tag me-1"></i>Categoría</label>
                                ...
                                <!-- Prioridad (se asignará automáticamente, pero se muestra) -->
                                <div class="col-md-6">
                                    <label class="form-label fw-bold"><i class="fas fa-flag me-1"></i>Prioridad sugerida</label>
                                    <div class="mt-2">
                                        <span class="badge bg-secondary" id="prioridadSugerida">Según categoría</span>
                                        <small class="text-muted d-block">La prioridad se asignará automáticamente</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Descripción -->
                            <div class="mb-3 mt-3">
                                <label for="descripcion" class="form-label fw-bold"><i class="fas fa-align-left me-1"></i>Descripción detallada</label>
                                <textarea class="form-control" id="descripcion" rows="5" placeholder="Describe tu problema con el mayor detalle posible..." required></textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Puedes adjuntar imágenes, capturas de pantalla o documentos (máx. 5MB)</small>
                            </div>
                ...
                <div class="alert alert-info mt-4">
                    ...
                    <strong>¿Sabías que...?</strong> El sistema asignará automáticamente un agente según la categoría y prioridad de tu ticket. Recibirás notificaciones en cada cambio de estado.
                </div>
    ...
    <script>
        // Simulación: cambiar prioridad sugerida según categoría
        document.getElementById('categoria').addEventListener('change', function() {
            ...
            prioridadSpan.textContent = map[this.value] || 'Según categoría';
