<%-- 
    Document   : users
    Created on : 13/08/2026, 1:45:48 p. m.
    Author     : Dissmax
--%>
        ...
        <div class="row">
            ...
            <main class="col-md-10 ms-sm-auto px-md-4 py-4">
                <div class="d-flex justify-content-between align-items-center pb-2 mb-3 border-bottom">
                    <h1 class="h2"><i class="fas fa-users me-2 text-primary"></i>Gestión de Usuarios</h1>
                    ...
                    <div class="card-body p-0">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td><i class="fas fa-user-circle me-2"></i>María González</td>
                                ...
                                <tr>
                                    <td>2</td>
                                    <td><i class="fas fa-user-circle me-2"></i>Carlos Rodríguez</td>
                                ...
                                <tr>
                                    <td>3</td>
                                    <td><i class="fas fa-user-circle me-2"></i>Ana Martínez</td>
                                ...
                                <tr>
                                    <td>4</td>
                                    <td><i class="fas fa-user-circle me-2"></i>Luis Gómez</td>
